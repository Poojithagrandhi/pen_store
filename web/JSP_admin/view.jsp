...
<html lang="en">
	...
	<body>
		...
		<header>
			...
			<div id="top-header">
				...
				<ul class="header-links pull-right">
                                            <li><a href="main.jsp"><i class="fa fa-user-md"></i> Add product</a></li>
					</ul>
		...
		<!-- NAVIGATION -->
                <div class="alert-info header-links" style="padding: 10px;margin: 20px">
                    PRODUCT DETAILS
                </div>
                ...
                <%
                          String email=(String) session.getAttribute("admin");
                            ...
                            PreparedStatement ps=con.prepareStatement("select * from item order by category");
                            ...
                            while(rs.next())
                            {
                                ...
                                <tbody>
                                <tr>
                                <td><%= rs.getString("itemno") %></td>
                                <td><%= rs.getString("name") %></td>
                                <td><%= rs.getString("price") %></td>
                                <td><a href="edit.jsp?a=<%= rs.getString("name") %>&a=<%= rs.getString("name") %>&b=<%= rs.getString("price") %>&c=<%= rs.getString("itemno") %>"><img src="../img/edit.jpg" height="20px"/></a></td>
                                <td><a href="delete.jsp?msg=<%= rs.getString("itemno") %>"><img src="../img/delete.jpg" height="20px"/></a></td>
                </tr>
                                </tbody>
                                <%
                            }
