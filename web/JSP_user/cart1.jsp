...
<%
		...
		<!-- SECTION -->
                ...
                String str="select * from cart where name=?";
                PreparedStatement ps=con.prepareStatement(str);
                ps.setString(1,em);
                ResultSet rs=ps.executeQuery();
                while(rs.next())
                {                                    
                    PreparedStatement ps1 = con.prepareStatement("select * from item where itemno=?");
                    ps1.setString(1, rs.getString("item"));
                    ResultSet rs1=ps1.executeQuery();
                    while(rs1.next())
                    {
                    String ft=rs1.getString("fileType");
                    %>
                    <div class="product col-md-3" style="margin-left: 500px">
                                <div class="product-img">
                                    ...
                                    %>
                                    <center> 
                                        <img src="../dispImage?msg=<%=rs1.getString("id")%>"  height="200" width="200"/>
                                        <a href="delete.jsp?msg=<%=rs.getString("item")%>"><img src="../img/delete.jpg"  height="20" width="20"/></a>
                                        <h4>$<%= rs1.getString("price") %></h4>
