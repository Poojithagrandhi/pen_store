...
<%
		...
		<!-- SECTION -->
                ...
                String str="select * from item where category='ball' order by id desc";
				...
				<div class="product-btns">
                                    ...
                                    <a href="cart.jsp?msg=<%=rs.getString("itemno")%>&m=<%= 1 %>"><button class="btn-xs"><i class="fa fa-cart-plus"></i><span class="tooltip">quick view</span></button></a>
